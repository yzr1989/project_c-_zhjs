...
{
	hardtype = "1001";
	hardtype_name ="three_phase_meter";
	...
	stop_bit = 1 ;
	file_no =0 ;	
	//cout  << "three_phase_meter"<<endl;	
	LOG_INFO<<"three_phase_meter";
}
...
int three_phase_meter::hardtype_op(shared_ptr<harddevice> Ptrhdharddevice, Connection  conn )
{


//	int ret =0;
	cout  << "three_phase_meter op "<<endl;	
...
{
	shared_ptr<hardtype> Ptr_three_phase_meter ( new  three_phase_meter());
	Registerhardtype( Ptr_three_phase_meter,hardtype_list);
	return 0;	
}
